...
public class T4Task8 {

	public static void main(String[] args) {
		T4Task8 t4T8 = new T4Task8();
		t4T8.go();
	}
	...
	private class PaintSurface extends JComponent {
		...
		public void paint(Graphics g) {
			...
			myShapeTire = new Ellipse2D.Double(topLeftX+150, topLeftY+150, width-300, height-300);
			...
			g2D.fill(myShape);
			g2D.draw(myShapeTire);
			g2D.setColor(Color.BLUE);
			g2D.fill(myShapeTire);
		}
	}
}